export const SVCS = [
  // 1. Emergency
  {id:1, icon:"emergency", name:"জরুরি সেবা",          nameEn:"Emergency Services",   col:"#DD392E", count:null,  avg:"৳বিনামূল্যে",r:null,
  ...
  // 2. Home Maintenance
  {id:2, icon:"home-maintenance", name:"গৃহ রক্ষণাবেক্ষণ",    nameEn:"Home Maintenance",      col:"#C85321", count:null, avg:"৳৩৫০",  r:null,
  ...
  // 3. Cleaning
  {id:3, icon:"cleaning", name:"পরিষ্কার সেবা",       nameEn:"Cleaning Services",     col:"#168488", count:null, avg:"৳৪০০",  r:null,
  ...
  // 4. Home Healthcare
  {id:4, icon:"healthcare", name:"স্বাস্থ্যসেবা",       nameEn:"Home Healthcare",       col:"#DD2F69", count:null, avg:"৳৫০০",  r:null,
  ...
  // 5. Education
  {id:5, icon:"education", name:"শিক্ষা সেবা",         nameEn:"Education & Learning",  col:"#217AC9", count:null, avg:"৳৪০০",  r:null,
  ...
  // 6. Moving & Transport
  {id:6, icon:"moving", name:"স্থানান্তর ও পরিবহন", nameEn:"Moving & Transport",    col:"#AA681C", count:null,  avg:"৳২০০০", r:null,
  ...
  // 7. Food & Cooking
  {id:7, icon:"food", name:"রান্না ও খাবার সেবা", nameEn:"Food & Cooking",        col:"#947318", count:null,  avg:"৳৬০০",  r:null,
  ...
  // 8. Professional
  {id:8, icon:"professional", name:"পেশাদার পরামর্শ",    nameEn:"Professional Services", col:"#5D6BE5", count:null, avg:"৳৮০০",  r:null,
  ...
  // 9. Security
  {id:9, icon:"security", name:"নিরাপত্তা সেবা",     nameEn:"Security Services",    col:"#3C73DF", count:null,  avg:"৳৫০০",  r:null,
  ...
  // 10. Daily Errands
  {id:10, icon:"errands", name:"দৈনন্দিন সহায়তা",   nameEn:"Daily Errands",        col:"#DB2492", count:null,  avg:"৳১৫০",  r:null,
  ...
  {id:11, icon:"elderly", name:"বয়স্ক সেবা",         nameEn:"Elderly Assistance",   col:"#8C5AE4", count:null,  avg:"৳৪০০",  r:null,
  ...
  // 12. Child & Family
  {id:12, icon:"childcare", name:"শিশু ও পরিবার সেবা", nameEn:"Child & Family Support",col:"#A54BE2", count:null,  avg:"৳৪০০",  r:null,
   subs:["বেবিসিটিং","শিশু পরিচর্যা","স্কুল পিকআপ/ড্রপ","শিশু পড়ানো"],
   subsEn:["Babysitting","Child Care","School Pickup/Drop","Child Tutoring"]},

  // 13. Agro & Rural
  {id:13, icon:"agro", name:"কৃষি ও গ্রামীণ সেবা", nameEn:"Agro & Rural Services", col:"#3C8816", count:null,  avg:"৳৩৫০",  r:null,
  ...
  // 14. Events
  {id:14, icon:"events", name:"ইভেন্ট ও ব্যক্তিগত",nameEn:"Event & Personal",      col:"#C429DC", count:null,  avg:"৳১৫০০", r:null,
  ...
  // 15. Lifestyle
  {id:15, icon:"lifestyle", name:"ব্যক্তিগত জীবনধারা", nameEn:"Personal Lifestyle",    col:"#D222BB", count:null,  avg:"৳৩০০",  r:null,
  ...
  // 16. Repair & Technical
  {id:16, icon:"repair", name:"মেরামত ও প্রযুক্তি",  nameEn:"Repair & Technical",   col:"#1B80A5", count:null, avg:"৳৩৫০",  r:null,
  ...
  // 17. Smart & Digital
  {id:17, icon:"digital", name:"স্মার্ট সহায়তা",     nameEn:"Smart & Digital Help",  col:"#7564E6", count:null,  avg:"৳২০০",  r:null,
  ...
  {id:18, icon:"utility", name:"ইউটিলিটি স্থাপন",    nameEn:"Utility Installation",  col:"#1A8A16", count:null,  avg:"৳৫০০",  r:null,
  ...
  // 19. Beauty & Salon
  {id:19, icon:"beauty", name:"বিউটি ও সেলুন",      nameEn:"Beauty & Salon",        col:"#168A31", count:null, avg:"৳৩৫০",  r:null,
...
export const AN_ACTIVITY=[{icon:"electrician",title:"Electrician booked",titleBn:"ইলেকট্রিশিয়ান বুক",date:"Today, 10:30 AM",amt:-385},{icon:"star",title:"Rated Farzana 5",titleBn:"ফারজানাকে ৫ রেটিং দিলেন",date:"Yesterday",amt:0},{icon:"card",title:"Wallet topped up",titleBn:"ওয়ালেট টপআপ",date:"2 days ago",amt:1000},{icon:"repair",title:"Plumber booking",titleBn:"প্লাম্বার বুকিং",date:"3 days ago",amt:-280}];
